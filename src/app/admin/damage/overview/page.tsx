  ...
  return (
    <div className="w-[Calc(100vw-12rem)] grid grid-cols-5 gap-6 border-2">
      ...
      <ContentBox className="col-start-1">
        <FontAwesomeIcon
          icon={faToolbox}
          className="bg-[#7cccd7] p-2 m-[2px] hover:m-[0px] rounded-md hover:p-[10px] hover:cursor-pointer duration-200"
        />
      ...
      <ContentBox className="col-start-2">
        <FontAwesomeIcon
          icon={faToolbox}
          className="bg-[#fff1b0] p-2 m-[2px] hover:m-[0px] rounded-md hover:p-[10px] hover:cursor-pointer duration-200"
        />
      ...
      <ContentBox className="col-start-3">
        <FontAwesomeIcon
          icon={faToolbox}
          className="bg-[#fce0b6] p-2 m-[2px] hover:m-[0px] rounded-md hover:p-[10px] hover:cursor-pointer duration-200"
        />
      ...
      <ContentBox className="col-start-4">
        <FontAwesomeIcon
          icon={faToolbox}
          className="bg-[#ffc8c8] p-2 m-[2px] hover:m-[0px] rounded-md hover:p-[10px] hover:cursor-pointer duration-200"
        />
